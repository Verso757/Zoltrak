    ...
    <div class="bg-white border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 flex gap-2 py-2">
            ...
            <button onclick="switchTab('qrTab')" id="btn-qrTab" class="tab-btn px-4 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-100 rounded-lg transition-colors">
                📲 3. Generador QR Enrolamiento (Kiosk + Seguridad)
            </button>
        </div>
    </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex-1 w-full space-y-6">
                ...
                <div class="lg:col-span-5 bg-white border border-slate-200 rounded-xl p-6 shadow-xs space-y-4">
                    ...
                    <form id="uploadApkForm" onsubmit="handleUploadApk(event)" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="changelog" rows="2" class="w-full text-xs border border-slate-200 rounded-lg p-2 bg-slate-50 focus:bg-white focus:outline-none focus:border-slate-900" placeholder="Compilación con modo Kiosco, Bluetooth libre para impresoras y botón de caché"></textarea>
                        </div>
        ...
        <div id="qrTab" class="tab-content hidden space-y-6">
            <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-xs">
                <div class="max-w-3xl">
                    <h2 class="text-base font-bold text-slate-900 mb-1">Enrolamiento Zero-Touch &amp; Device Owner (Políticas Kiosco)</h2>
                    <p class="text-xs text-slate-500 mb-4">
                        Este código QR convierte cualquier teléfono Android restaurado de fábrica en un terminal corporativo blindado para reparto.
                    </p>
                </div>

                <!-- Resumen de Políticas Aplicadas por el QR -->
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                    <div class="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs">
                        <div class="font-bold text-slate-800 mb-1">🚫 Cero Apps de Terceros</div>
                        <p class="text-[11px] text-slate-500">Play Store desactivado. Bloqueo total de instalación y APKs externos.</p>
                    </div>
                    <div class="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs">
                        <div class="font-bold text-slate-800 mb-1">📡 GPS y Datos Blindados</div>
                        <p class="text-[11px] text-slate-500">Imposible apagar datos móviles o ubicación GPS sin permiso del sistema.</p>
                    </div>
                    <div class="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs">
                        <div class="font-bold text-slate-800 mb-1">🖨️ Bluetooth Libre</div>
                        <p class="text-[11px] text-slate-500">Acceso rápido para choferes al selector de impresoras térmicas de tickets.</p>
                    </div>
                    <div class="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs">
                        <div class="font-bold text-slate-800 mb-1">🧹 Atajo de Limpieza Caché</div>
                        <p class="text-[11px] text-slate-500">Botón de un toque para desatorar o limpiar la app de ventas si falla.</p>
                    </div>
                </div>
